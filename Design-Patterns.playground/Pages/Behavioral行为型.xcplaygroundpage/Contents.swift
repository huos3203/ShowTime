...
//ATM取款机
final class ATM {
    private var hundred: MoneyPile //百元堆
    private var fifty: MoneyPile   //50元堆
    private var twenty: MoneyPile  //20元
    private var ten: MoneyPile     //10元
