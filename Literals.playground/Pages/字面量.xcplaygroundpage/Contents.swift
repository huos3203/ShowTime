import UIKit
//: ### [Playgrounds中的字面量（Literals）](http://www.cocoachina.com/ios/20151020/13800.html)
//:
//: ###### Image Literals
...
//[#FileReference(fileReferenceLiteral: "swiftAsASCII.txt")#]
...
if let asciiSwift = try? String(contentsOf: #fileLiteral(resourceName: "swiftAsASCII.txt")) {
    if let font = UIFont(name: "Courier", size: 10.0) {
        let attrString = NSAttributedString(string: asciiSwift, attributes: [NSAttributedStringKey.font : font])
    }
}
