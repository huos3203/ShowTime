...
extension SCNTransaction {
    public class func animateWithDuration(_ duration: CFTimeInterval = 0.25, timingFunction: CAMediaTimingFunction? = nil, completionBlock: (() -> Void)? = nil, animations: () -> Void) {
        begin()
...
extension SCNAudioSource {
    public convenience init(name: String, volume: Float = 1.0, positional: Bool = true, loops: Bool = false, shouldStream: Bool = false, shouldLoad: Bool = true) {
...
extension CAAnimation {
    public class func animationWithSceneNamed(_ name: String) -> CAAnimation? {
